...
<section class="py-20 lg:py-32 flex flex-col gap-24" id="projects">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-10">
        ...
        <Step step={steps[1]}>
            <p>
                Ultimate Todos is a Full Stack <strong
                    class="text-orange-400">Next.js</strong
                >,
                <strong class="text-orange-400">Node.js + Express.js</strong
                >
                & <strong class="text-orange-400">Firebase</strong> CRUD application
        ...
        <Step step={steps[2]}>
            <p>
                The Pokédex is a <strong class="text-orange-400"
                    >SvelteKit & TailwindCSS</strong
                >
                web application, hosted on
                <strong class="text-orange-400">Netlify</strong>, that
                consumes and caches the
                <strong class="text-orange-400">Pokémon API</strong>
